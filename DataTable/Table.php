...
<body>
    ...
    <div class="conatiner">
        <div class="row">
            <div class="col-10 my-5 mx-auto border">

                <h3 class="my-4 text-center">Client details</h3>
                        ...
                        <tbody>
                         ...
                         <?php 
                                                ...
                                                while($row = mysqli_fetch_assoc($result)){
                                                        ...
                                                        <td>".$row['Name']."</td>
                                                        <td>".$row['Services']."</td>
                                                        <td> <img width='100px' height='100px' src = ../DataForm/".$row['Thumbnail_Image'].">  </img></td>
                                                        <td>".$row['Images']."</td>
                                                    </tr>";
